// Menú del sistema, listo para operar de acuerdo a la configuración de los perfiles
// Archivo: src\app\contenedores\MenuLateral.tsx
...
//Para poner por defecto a todos el menu admin(no hacerlo):
  opciones = opcionesAdmin;
