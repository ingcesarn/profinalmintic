// Ruteo para la parte interna del dashBoard
// Archivo: src\app\utilidades\rutas\RuteoTablero.tsx
...
const LazyPerfilListado  = lazy(() =>
  import("../../vistas/privadas/perfiles/PerfilListado").then(() => ({
    default: PerfilListado,
  }))
);

const LazyPerfilCrear = lazy(() =>
  import("../../vistas/privadas/perfiles/PerfilCrear").then(() => ({
    default: PerfilCrear,
  }))
);

const LazyPerfilAdmin = lazy(() =>
  import("../../vistas/privadas/perfiles/PerfilAdmin").then(() => ({
    default: PerfilAdmin,
  }))
);

const LazyPerfilActual = lazy(() =>
  import("../../vistas/privadas/perfiles/PerfilActual").then(() => ({
    default: PerfilActual,
  }))
);
